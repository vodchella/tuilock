...
@(private = "file")
ncurses_bits :: #force_inline proc "contextless" (mask, shift: c.uint) -> c.int
{
...
foreign ncurses {
	...
	mvwchgat  :: proc(win: ^Window, y, x, n: c.int, attr: c.int, color_pair: c.short, opts: rawptr) -> c.int ---
